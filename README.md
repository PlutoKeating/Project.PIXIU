...
当前项目报告为34页宣传片对齐路演稿，按正式成片的内容和顺序覆盖30个镜头；六章目录标明页码并支持跳转。采购核算、活动资料、家庭账单、知识维护和可信设备协作均采用片中案例。页序见 [路演说明](docs/delivery/PRESENTATION_AND_VIDEO.md)，逐页图像与视频映射见 [PPT制作工程](submission/presentation-production/README.md)。
