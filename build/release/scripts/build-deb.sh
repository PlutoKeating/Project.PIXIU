...
mkdir -p "${BK}/agent/runtime"
install -m 0644 "${PIXIU_ROOT}/backend/agent/runtime/image_draft.py" "${PIXIU_ROOT}/backend/agent/runtime/document_tasks.py" "${BK}/agent/runtime/"
