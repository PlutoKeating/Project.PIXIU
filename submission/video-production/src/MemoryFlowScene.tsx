...
export const MemoryFlowScene:React.FC=()=>{
 ...
 </div><Steps labels={['记录上下文','保存到长期','带回新任务']} cues={[cue('s17','当前轮次'),cue('s17','需要长期'),cue('s17','检索时')]}/><div style={{position:'absolute',left:135,top: 896,fontSize:36,color:'#526477'}}>记忆流转示意 · 接口实测摘要</div></AbsoluteFill>;
};
