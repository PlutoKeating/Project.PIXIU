...
export const BRAND_INK_OPEN_DURATION = 300;
...
const WORDMARK = 'PIXIU · 貔貅';
const KICKER = '面向麒麟智能体的分布式集体记忆';
...
export const BrandInkOpen: React.FC = () => {
  ...
  const brandOut = interpolate(frame, [293, 300], [0, 1], {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#f6f7f9', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ textAlign: 'center', opacity: brandOpacity, transform: `translateY(${groupY}px) scale(${groupScale})` }}>
        ...
        <div
          style={{
            fontFamily: SERIF, fontSize: 144, fontWeight: 600, color: INK,
        ...
        <div
          style={{
            fontFamily: MONO, fontSize: 34, letterSpacing: '0.14em', color: INK2,
