...
export const BehaviorCaptureScene: React.FC = () => {
  ...
  return <AbsoluteFill>
    <div style={{position: 'absolute', left: 135, right: 135, top: 200}}>
      ...
      {f < 123 ? <>
        <Crop src="20260909-公开行为来源正文-4K.png" x={1512} y={937} w={1250} h={88} scale={1.3} />
        <div style={{fontSize: 38, marginTop: 45, marginBottom: 25}}>本次公开窗口焦点时长：118 秒</div>
        <Crop src="20260909-公开行为来源正文-4K.png" x={1570} y={1407} w={1000} h={43} scale={1.35} />
      </> : f < 190 ? <>
        <Crop src="33-capture-disabled.png" x={8} y={239} w={620} h={29} scale={2.6} width={1440} height={900} />
        <div style={{fontSize: 38, marginTop: 55}}>当前：关闭</div>
