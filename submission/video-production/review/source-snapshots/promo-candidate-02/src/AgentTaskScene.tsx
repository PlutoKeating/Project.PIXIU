...
export const AgentTaskScene: React.FC = () => {
  ...
  const gateway = frame < 161;
  return <AbsoluteFill>
    <Reveal at={frame<161?0:frame<324?161:frame<462?324:462} style={{position: 'absolute', left: 135, right: 135, top: 185}}>
    ...
    <div style={{position: 'absolute', left: 135, top: 905, fontSize: 36, color: '#526477'}}>
      {gateway ? '工具日志与文件原文摘录 · 公开合成任务' : frame < 324
        ? '采购复核单 · 保存为记忆'
        : '原生界面裁片 · 显式记忆检索复用'}
    </div>
  </AbsoluteFill>;
