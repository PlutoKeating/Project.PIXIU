...
export const BehaviorCaptureScene:React.FC=()=>{
 ...
 <Reveal at={details} style={{display:'flex',alignItems:'center',gap:45,marginTop:40}}><div style={{fontSize:108,color:'#1456b8',fontVariantNumeric:'tabular-nums'}}>{Math.round(interpolate(f,[details,details+30],[0,118],ease))}<span style={{fontSize:38}}> 秒</span></div><div style={{fontSize:38}}>本次应用使用时长</div></Reveal>
 <Reveal at={details+45} style={{marginTop:36}}><Crop src="20260909-公开行为来源正文-4K.png" x={1570} y={1407} w={1000} h={43} scale={1.35}/></Reveal></>
