import {AbsoluteFill, Audio, Sequence, interpolate, useCurrentFrame, staticFile, Easing} from 'remotion';
...
const SCREENS: Record<string, string[]> = {
  ...
  s07: ['06-agent-remember.png', '16-agent-recall-result.png'],
  s08: ['17-agent-source.png'],
...
const ScreenScene: React.FC<{shot: Shot}> = ({shot}) => {
  ...
  const crop = {x: floating ? 120 : 0, y: 38, w: floating ? 1200 : 1440, h: 740};
