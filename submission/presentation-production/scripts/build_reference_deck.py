...
TITLES = ['PIXIU · 貔貅','汇报导览','多设备 Agent 的记忆断点','需求缺口与方案回应','桌面智能体记忆中枢','业务与技术全景','两大核心亮点','自动记忆，持续整合','场景示例 · 账单检索','偏好演进与版本历史','记忆共享，分布互连','持续记忆技术体系','多源知识接入','知识结构与来源关联','三路混合检索','记忆阶段流转','双层冲突治理','去中心化同步协议','全生命周期安全','原生部署与兼容路径','智能体记忆生命周期','真实操作案例','活动资料与任务要素','自动记忆，持续整合｜跨会话召回','自动记忆，持续整合｜更正审批','场景应用价值','开发基线量化评测','记忆共享，分布互连｜三端收敛','验证结果与待测范围','服务模式与持续运营','商业试点路线','PIXIU · 貔貅']
SIDE = {5,9}
...
narrative('PIXIU 为 Agent 持续保存、整合记忆，并在可信设备间按授权共享。',.8,6.76,11.73,.34,
          [('整合记忆',GOLD),('按授权共享',GOLD)],19,PP_ALIGN.CENTER)
...
# 20 – Exact source technical-feature panel and proof panel composition.
s=base('',4,4,[22])
...
# 21 – Runtime with genuine tools screenshot.
