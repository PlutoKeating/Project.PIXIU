...
```
┌────────────────────────────────────────────┐
│  PIXIU 貔貅            ●在线 3设备  ⚙  ▤  ✕ │  ← 顶栏：标题/同步状态/设置/面板/关闭
├────────────────────────────────────────────┤
│                                              │
│   ┌──────────────────────────────────┐      │
...
│                                              │
├────────────────────────────────────────────┤
│ [📎] 输入问题，或拖入图片录入…      [ 发送 ] │  ← 输入栏 InputBar
└────────────────────────────────────────────┘
```

- 无边框、圆角 + 阴影窗口（`KTranslucentFloor`），宽约 420px，高度自适应/可拉伸。
...
- 基础间距栅格：4 / 8 / 12 / 16px。
- 窗口圆角 12px，气泡圆角 10px，按钮圆角 8px；无边框窗口配柔和阴影。
