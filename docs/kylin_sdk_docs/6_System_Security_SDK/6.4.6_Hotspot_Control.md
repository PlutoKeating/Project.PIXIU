...
**原型**:
```c
int kdk_device_set_wireless_ap_status(int status)
```
...
**原型**:
```c
int kdk_device_get_wireless_ap_status()
```
...
**原型**:
```c
int kdk_device_set_wireless_ap_bwm(int mode)
```
...
**原型**:
```c
kdk_device_get_wireless_ap_bwm()
```
...
**原型**:
```c
int kdk_device_set_wireless_ap_blacklist(const char *mac)
```
...
**原型**:
```c
int kdk_device_del_wireless_ap_blacklist(const char *mac)
```
...
**原型**:
```c
int kdk_device_clear_wireless_ap_blacklist()
```
...
**原型**:
```c
char** kdk_device_get_wireless_ap_blacklist(int *len)
```
...
| 返回值 | 说明 |
|--------|------|
| `char**` | 黑名单列表，使用完需手动释放字符串数组 -5000 门禁管控禁止访问 |
...
**原型**:
```c
int kdk_device_set_wireless_ap_whitelist(const char *mac)
```
...
**原型**:
```c
int kdk_device_del_wireless_ap_whitelist(const char *mac)
```
...
**原型**:
```c
int kdk_device_clear_wireless_ap_whitelist()
```
...
**原型**:
```c
char** kdk_device_get_wireless_ap_whitelist(int *len)
```
...
| 返回值 | 说明 |
|--------|------|
| `char**` | 白名单列表，使用完需手动释放字符串数组 -5000 门禁管控禁止访问 |
