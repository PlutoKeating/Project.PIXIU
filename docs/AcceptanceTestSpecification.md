...
3. A-01～A-10 完整 Agent 闭环。
4. F1～F7 与附录 A 场景。
5. P-01～P-04 最终 V11 双 SDK 性能。
6. N-01～N-08 多设备创新专项。
7. D-01～D-10 交付复核，按 S1/S2 独立评分。

总体验收只有在三项 `[GATE]`、全部关键 `[M]`、完整 Agent 端到端链路和证据材料均通过后，才能表述为“赛题验收通过”。单元测试通过、客户端能启动或 portable 指标达标都不能单独推出这一结论。
