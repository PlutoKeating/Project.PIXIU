...
>
> 2026-09-08 交付口径更新：作品内容、份数、格式、命名与匿名要求唯一以
> [赛方交付作品要求冻结记录](DELIVERY_PLAN.md#0-赛方交付作品要求唯一权威永久冻结)
> 为准；本规范其余技术验收条目继续适用。
>
...
交付作品要求及目录以 [交付计划 §0](DELIVERY_PLAN.md#0-赛方交付作品要求唯一权威永久冻结)
的三张赛方图片冻结记录为唯一依据。以下 D/A 编号仅用于内部验收追踪，不是官方
顶层目录；用户手册、部署指南、效果验证报告纳入技术方案，提交内容一律匿名。

| 编号 | 交付项 | 必须内容/格式 |
|------|--------|---------------|
| D-01 `[D]` | 项目报告 PPT | 完整内容、份数和格式按交付计划 §0.1～§0.3；不得出现可识别团队身份信息 |
...
| D-05 `[D]` | 演示视频 | 按交付计划 §0.1～§0.3：5-10 分钟，zip，大小不超过 200M；讲解演示所有已实现核心功能，建议字幕，内容匿名 |
