...
> 交付条款于 2026-09-08 按用户提供的赛方图片更新；本文为更新后的赛题记录。
> 作品内容、份数、格式、目录命名和匿名要求唯一见
> [冻结交付要求](DELIVERY_PLAN.md#0-赛方交付作品要求唯一权威永久冻结)。
...
作品提交内容完整执行[赛方交付作品要求](DELIVERY_PLAN.md#0-赛方交付作品要求唯一权威永久冻结)。
项目报告、技术方案、功能演示视频、源代码各 1 份；技术方案内包含用户手册、
安装部署指南、操作说明、测试结果和效果验证报告。作品内容必须匿名。
...
按[赛方交付作品要求冻结记录](DELIVERY_PLAN.md#0-赛方交付作品要求唯一权威永久冻结)
执行四项作品的完整内容、格式、份数和匿名要求，按其中两层同名目录结构组织提交。
学校、作品名称与主申报人姓名使用该记录中的确认值，命名信息须与平台一致。
