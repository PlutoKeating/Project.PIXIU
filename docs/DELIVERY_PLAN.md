...
| 功能演示视频 | 1 份，5-10 分钟，`演示视频.zip`，大小不超过 200M | `delivery/PRESENTATION_AND_VIDEO.md`、`submission/video-production/` | 第十版中文初剪已生成，9 分 14 秒、约 55.1 MB；同步检查点、历史量化表、高清偏好堆叠及非标题搜索已入片，整片解码通过，偏好与搜索镜头有限独立复核无阻断项；独立审查仍有功能/模板/视听余项，正式 ZIP 待完成 |
