...
2026-09-06 的 [22 张同版实拍素材](../submission/00-原始记录/截图素材索引.md)
对应 v0.1.8 / `08cc691`，覆盖安装、启动、Agent、手动记忆与原文、更新检查；
目录内提供 SHA-256 和使用边界。原三张失效原图已删除、无历史副本。
该素材集不替代下面要求的完整状态矩阵，也不包含旧验证数据的展示。
