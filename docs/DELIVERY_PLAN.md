...
| V11 双 SDK 严格画像 | `829d944` 同包原生证据完成 direct SDK 和产品写查遗忘，双 SDK compliant、`contest_ready=true` | 技术门通过；最终冻结 commit 重跑归档 |
...
执行 SDK 的装载、集合、向量及断开生命周期。`829d944` 已生成真实通过输出并绑定
