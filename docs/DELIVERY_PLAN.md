...
| 功能演示视频 | 1 份，5-10 分钟，`演示视频.zip`，大小不超过 200M | `delivery/PRESENTATION_AND_VIDEO.md`、`submission/video-production/` | 30 镜中文全片初剪已生成，9 分 3 秒、约 39 MB；三端同步复验与部分操作录屏已归档，镜头精修、终检及正式 ZIP 待完成 |
