...
| 功能演示视频 | 1 份，5-10 分钟，`演示视频.zip`，大小不超过 200M | `delivery/PRESENTATION_AND_VIDEO.md`、`submission/video-production/` | 第三版中文初剪已生成，9 分 3 秒、约 41 MB；组装片尾与声轨补偿已接入，三端同步及 Agent 显式跨端检索素材已归档；功能镜头精修、终检及正式 ZIP 待完成 |
