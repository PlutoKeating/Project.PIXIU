...
| 功能演示视频 | 1 份，5-10 分钟，`演示视频.zip`，大小不超过 200M | `delivery/PRESENTATION_AND_VIDEO.md`、`submission/video-production/` | 第十二版中文初剪已生成，9 分 18 秒、约 55.7 MB；同步检查点、历史量化表、高清偏好堆叠、非标题搜索及洞察来源链已入片，整片解码通过；洞察日期字号与来源时序通过有限复核，仍有功能/模板细节/视听余项，正式 ZIP 待完成 |
