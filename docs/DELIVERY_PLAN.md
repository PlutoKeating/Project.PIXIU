...
| 功能演示视频 | 1 份，5-10 分钟，`演示视频.zip`，大小不超过 200M | `delivery/PRESENTATION_AND_VIDEO.md`、`submission/video-production/` | 第八版中文初剪已生成，9 分 14 秒、约 56.1 MB；同步检查点、历史量化表及偏好堆叠初版已入片，整片解码通过，新增动效仍待独立复核；独立审查仍有功能/模板/视听余项，正式 ZIP 待完成 |
